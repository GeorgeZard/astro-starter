...
// Helper function to transform icon names (equivalent to getIconName in StarFunnel)
const getIconName = (val) => {
  if (!val) return null
  return val.replace('.svg', '').replace('-', '')
}
...
const config = defineCollection({
  ...
  schema: z.object({
    ...
    footer_brand_name: z.string().optional(),
    footer_tagline: z.string().optional(),
    footer_social_links: z.array(z.object({
...
export const collections = { projects, blog, page, config }
